...
func GenerateSSL(domain string) error {
	...
	certOut, err := os.OpenFile(global.Config.System.PanelPath+"/data/secret/server.crt.tmp", os.O_WRONLY|os.O_CREATE|os.O_TRUNC, 0600)
	if err != nil {
		return err
	}
	...
	keyOut, err := os.OpenFile(global.Config.System.PanelPath+"/data/secret/server.key.tmp", os.O_WRONLY|os.O_CREATE|os.O_TRUNC, 0600)
	if err != nil {
		return err
	}
